...
public class MMItems {
    ...
    public static final RegistryObject<Item> MANA_POTION = ITEMS.register("mana_potion", () -> (ManaPotion) ((Tooltip) new ManaPotion(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).durability(3).food(new FoodProperties.Builder().alwaysEat().build()))).manaMod$setTooltipProperties(new TooltipProperties().descriptionItem().WIP()));
